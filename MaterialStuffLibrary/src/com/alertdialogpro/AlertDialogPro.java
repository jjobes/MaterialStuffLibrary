...
public class AlertDialogPro extends AlertDialog implements DialogInterface
{
    ...
    protected AlertDialogPro(final Context context)
    {
        this(context,resolveDialogTheme(context,0));
    }

    protected AlertDialogPro(final Context context,final int theme)
    {
        super(context,theme);
    }
    ...
    static int resolveDialogTheme(final Context context,final int resid)
    {
        ...
        else
        {
            ...
            context.getTheme().resolveAttribute(R.attr.alertDialogProTheme,outValue,true);
     ...
     *
     * @param whichButton Which button to set the message for, can be one of {@link DialogInterface#BUTTON_POSITIVE}, {@link DialogInterface#BUTTON_NEGATIVE}, or {@link DialogInterface#BUTTON_NEUTRAL}
     ...
     *
     * @param whichButton Which button to set the listener on, can be one of {@link DialogInterface#BUTTON_POSITIVE}, {@link DialogInterface#BUTTON_NEGATIVE}, or {@link DialogInterface#BUTTON_NEUTRAL}
     * @param text The text to display in positive button.
    ...
    public static class Builder extends AlertDialog.Builder
    {
         ...
         */
        public Builder(final Context context,final int theme)
        {
            super(context);
            mTheme=resolveDialogTheme(context,theme);
            P=new AlertController.AlertParams(new ContextThemeWrapper(context,mTheme));
        }
         ...
         */
        @Override
        public Builder setPositiveButton(final int textId,final OnClickListener listener)
        {
         ...
         */
        @Override
        public Builder setPositiveButton(final CharSequence text,final OnClickListener listener)
        {
         ...
         */
        @Override
        public Builder setNegativeButton(final int textId,final OnClickListener listener)
        {
         ...
         */
        @Override
        public Builder setNegativeButton(final CharSequence text,final OnClickListener listener)
        {
         ...
         */
        @Override
        public Builder setNeutralButton(final int textId,final OnClickListener listener)
        {
         ...
         */
        @Override
        public Builder setNeutralButton(final CharSequence text,final OnClickListener listener)
        {
         ...
         */
        @Override
        public Builder setItems(final int itemsId,final OnClickListener listener)
        {
         ...
         */
        @Override
        public Builder setCursor(final Cursor cursor,final OnClickListener listener,final String labelColumn)
        {
            P.mCursor=cursor;
         ...
         */
        @Override
        public Builder setSingleChoiceItems(final int itemsId,final int checkedItem,final OnClickListener listener)
        {
            P.mItems=P.mContext.getResources().getTextArray(itemsId);
            P.mOnClickListener=listener;
         ...
         */
        @Override
        public Builder setSingleChoiceItems(final Cursor cursor,final int checkedItem,final String labelColumn,final OnClickListener listener)
        {
            P.mCursor=cursor;
            P.mOnClickListener=listener;
            P.mCheckedItem=checkedItem;
         ...
         */
        @Override
        public Builder setSingleChoiceItems(final CharSequence[] items,final int checkedItem,final OnClickListener listener)
        {
            P.mItems=items;
            P.mOnClickListener=listener;
            P.mCheckedItem=checkedItem;
         ...
         */
        @Override
        public Builder setSingleChoiceItems(final ListAdapter adapter,final int checkedItem,final OnClickListener listener)
        {
            P.mAdapter=adapter;
            P.mOnClickListener=listener;
            P.mCheckedItem=checkedItem;
        ...
        /**
         * Creates a {@link AlertDialogPro} with the arguments supplied to this builder. It does not {@link android.app.Dialog#show()} the dialog. This allows the user to do any extra processing
        ...
        {
            final AlertDialogPro dialog=new AlertDialogPro(P.mContext,mTheme);
        ...
        /**
         * Creates a {@link AlertDialogPro} with the arguments supplied to this builder and {@link android.app.Dialog#show()}'s the dialog.
         */
        @Override
        public AlertDialogPro show()
        {
            final AlertDialogPro dialog=create();
            dialog.show();
            return dialog;
        }
    }
