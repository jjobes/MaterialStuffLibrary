...
public class AlertController
{
    ...
    public AlertController(final Context context,final DialogInterface di,final Window window)
    {
        mContext=context;
        mDialogInterface=di;
        mWindow=window;
        mHandler=new ButtonHandler(di);
        final TypedArray a=context.obtainStyledAttributes(null,R.styleable.AlertDialogPro,R.attr.alertDialogProStyle,0);
        mAlertDialogLayout=a.getResourceId(R.styleable.AlertDialogPro_adpLayout,0);
        mListLayout=a.getResourceId(R.styleable.AlertDialogPro_adpListLayout,0);
        mMultiChoiceItemLayout=a.getResourceId(R.styleable.AlertDialogPro_adpMultiChoiceItemLayout,0);
        mSingleChoiceItemLayout=a.getResourceId(R.styleable.AlertDialogPro_adpSingleChoiceItemLayout,0);
        mListItemLayout=a.getResourceId(R.styleable.AlertDialogPro_adpListItemLayout,0);
        a.recycle();
    }
     ...
     *
     * @param whichButton Which button, can be one of {@link DialogInterface#BUTTON_POSITIVE}, {@link DialogInterface#BUTTON_NEGATIVE}, or {@link DialogInterface#BUTTON_NEUTRAL}
     * @param text The text to display in positive button.
     * @param listener The {@link DialogInterface.OnClickListener} to use.
     * @param msg The {@link Message} to be sent when clicked.
     */
    public void setButton(final int whichButton,final CharSequence text,final DialogInterface.OnClickListener listener,Message msg)
    {
    ...
    private void setupView()
    {
        ...
        else customPanel.setVisibility(View.GONE);
        ...
        if(hasTitle)
        {
            ...
            else divider=mWindow.findViewById(R.id.adp_titleDividerTop);
            if(divider!=null)
    ...
    private boolean setupTitle(final LinearLayout topPanel)
    {
        ...
        if(mCustomTitleView!=null)
        {
            ...
            final View titleTemplate=mWindow.findViewById(R.id.adp_title_template);
    ...
    private void setupContent(final LinearLayout contentPanel)
    {
        ...
        else
        {
            ...
            else contentPanel.setVisibility(View.GONE);
        }
    }
    ...
    public static class RecycleListView extends ListView
    {
        ...
        public RecycleListView(final Context context,final AttributeSet attrs,final int defStyle)
        {
    ...
    public static class AlertParams
    {
        ...
        private void createListView(final AlertController dialog)
        {
                ...
                if(mCursor==null)
                    adapter=new ArrayAdapter<CharSequence>(mContext,dialog.mMultiChoiceItemLayout,android.R.id.text1,mItems)
                    {
                        ...
                        public View getView(final int position,final View convertView,final ViewGroup parent)
                        {
                            ...
                            {
                                final boolean isItemChecked=mCheckedItems[position];
                                if(isItemChecked)
                    ...
                    else adapter=new CursorAdapter(mContext,mCursor,false)
                {
            ...
            else
            {
                ...
                if(mCursor==null)
                    adapter=mAdapter!=null ? mAdapter : new CheckedItemAdapter(mContext,layout,android.R.id.text1,mItems);
                else adapter=new SimpleCursorAdapter(mContext,layout,mCursor,new String[] {mLabelColumn},new int[] {android.R.id.text1});
            }
